...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_100 = Integer(100); _sage_const_10192004369 = Integer(10192004369); _sage_const_3 = Integer(3); _sage_const_7198247104 = Integer(7198247104); _sage_const_11520316802179 = Integer(11520316802179); _sage_const_2 = Integer(2); _sage_const_3970483220420 = Integer(3970483220420); _sage_const_795189633901933 = Integer(795189633901933); _sage_const_213666326927748 = Integer(213666326927748)
load("pollard_p.sage")
...
print("Answer: ",enhanced_pohlig_hellman(_sage_const_10192004369 , _sage_const_3  , _sage_const_7198247104 )) 
print("Answer: ",enhanced_pohlig_hellman(_sage_const_11520316802179 , _sage_const_2 , _sage_const_3970483220420 )) 
